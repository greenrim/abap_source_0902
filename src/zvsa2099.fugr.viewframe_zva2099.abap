*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZVA2099
*   generation date: 2022.08.01 at 10:14:31
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZVA2099             .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZVA2099'
         EXPORTING
              FCODE          = READ
...
CALL FUNCTION 'VIEWPROC_ZVA2099'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZVA2099-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZVA2099_EXTRACT
TOTAL = ZVA2099_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZVA2099-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZVA2099'
...
TOTAL = ZVA2099_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZVA2099-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZVA2099-UPD_FLAG NE SPACE.
