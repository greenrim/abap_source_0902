...
*  SELECTION-SCREEN BEGIN OF BLOCK radio WITH FRAME .
  SELECTION-SCREEN BEGIN OF LINE.
    SELECTION-SCREEN COMMENT 5(5) TEXT-t01.
    PARAMETERS pa_all RADIOBUTTON GROUP rbg1.
    SELECTION-SCREEN COMMENT 30(10) TEXT-t02. "pos_low(5)
    PARAMETERS pa_nat RADIOBUTTON GROUP rbg1.
    SELECTION-SCREEN COMMENT 50(10) TEXT-t03. " pos_high(5)
    PARAMETERS pa_int RADIOBUTTON GROUP rbg1 DEFAULT 'X'.
...
SELECTION-SCREEN BEGIN OF SCREEN 1400 AS SUBSCREEN.
  SELECT-OPTIONS : s_cofr FOR gs_flight-countryfr MODIF ID con,
  s_cifr FOR gs_flight-cityfrom MODIF ID con.
  "SELECTION-SCREEN SKIP 1. "이것도 한줄 아래에 버튼을 생성할 수 있음
  SELECTION-SCREEN PUSHBUTTON /10(20) gv_text USER-COMMAND click.
