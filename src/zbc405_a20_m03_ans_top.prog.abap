...
SELECTION-SCREEN BEGIN OF BLOCK bl1 WITH FRAME.
  SELECTION-SCREEN BEGIN OF LINE.
    SELECTION-SCREEN COMMENT 3(8) TEXT-t05 MODIF ID gr1.    "FOR FIELD pa_rad1.  "파라미터명 위치 지정
    SELECTION-SCREEN POSITION 12.                                   "파라미터 input field 위치 지정
    PARAMETERS pa_rad1 RADIOBUTTON GROUP rd1 MODIF ID gr1.
    SELECTION-SCREEN  COMMENT pos_low(7) TEXT-t06 MODIF ID gr1.
...
SELECTION-SCREEN BEGIN OF SCREEN 1300 AS SUBSCREEN.
  SELECT-OPTIONS so_fld FOR sflight-fldate MODIF ID gr1.
...
SELECTION-SCREEN BEGIN OF TABBED BLOCK ts_con FOR 5 LINES.
  ...
  SELECTION-SCREEN TAB (10) tab3 USER-COMMAND fld DEFAULT SCREEN 1300.
